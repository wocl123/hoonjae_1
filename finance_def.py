...
class Top_Price:
    ...
    def today_high():
        ...
        for i in range(0,15):
            ...
            high_list.append("1️⃣종목이름 : " + sinfo[1] + "\n2️⃣현재가격 : " + sinfo[2] + "\n3️⃣상승가격 : " + sinfo[3] + "\n4️⃣상승퍼센트 : " + sinfo[4] + "\n\n")
    ...
    def today_low():
        ...
        for i in range(0,15):
            ...
            sinfo = basic_info.split("\n")
            low_list.append("1️⃣종목이름 : " + sinfo[1] + "\n2️⃣현재가격 : " + sinfo[2] + "\n3️⃣하락가격 : " + sinfo[3] + "\n4️⃣하락퍼센트 : " + sinfo[4] + "\n\n")
    ...
    def today_trade():
        ...
        for i in range(0,15):
            ...
            sinfo = basic_info.split("\n")
            rank_list.append("1️⃣종목이름 : " + sinfo[1] + "\n2️⃣현재가격 : " + sinfo[2] + "\n3️⃣변동가격 : " + sinfo[3] + "\n4️⃣변동퍼센트 : " + sinfo[4] + "\n\n")
...
class Kos:
    def kospi_main():
        ...
        kospi_list = []
        kospi_list.append("1️⃣현재 코스피 지수 : " + kospi_price.text + "\n2️⃣거래량(천주) : " + kospi_trade[0].text + "\n3️⃣거래대금(백만) : " + 
                        kospi_trade2[0].text + "\n4️⃣장중최고 : " + kospi_trade[1].text + "\n5️⃣장중최저 : " + kospi_trade2[1].text + "\n6️⃣52주 최고 : " + 
                        kospi_trade[2].text + "\n7️⃣52주 최저 : " + kospi_trade2[2].text)
    ...
    def kosdaq_main():
        ...
        kosdaq_list = []
        kosdaq_list.append("1️⃣현재 코스닥 지수 : " + kosdaq_price.text + "\n2️⃣거래량(천주) : " + kosdaq_trade[0].text + "\n3️⃣거래대금(백만) : " + kosdaq_trade2[0].text + 
                        "\n4️⃣장중최고 : " + kosdaq_trade[1].text + "\n5️⃣장중최저 : " + kosdaq_trade2[1].text + "\n6️⃣52주 최고 : " + kosdaq_trade[2].text + 
                        "\n7️⃣52주 최저 : " + kosdaq_trade2[2].text)
